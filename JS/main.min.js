...
$(function () {
	...
	$('.header__list-link').on('click', function () {
		$('.header__list-link').removeClass('header__link--active')
		$(this).addClass('header__link--active');
	})
	$('.user__menu-img').on('click', function () {
		$('.user__list').toggleClass('user__list-active')
	})
	$('.dashboard__network-item').on('click', function(){
		$(this).toggleClass('dashboard__network-item--active');
	})
})
// import "./lazyload.js";
